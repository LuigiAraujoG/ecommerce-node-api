...
class CategoriaException extends DomainException {
    constructor(message: string = "Excução de Domínio Genérica da Entidade Categoria") {
       super(message)
...
class NomeCategoriaTamanhoMinimoInvalido extends CategoriaException {
    public constructor(message:string = "Onome da categoria não possui um tamanho mínimo válido."){
        super(message);
...
export {CategoriaException, NomeCategoriaNuloOuIndefinido, NomeCategoriaTamanhoMaximoInvalido, NomeCategoriaTamanhoMinimoInvalido};